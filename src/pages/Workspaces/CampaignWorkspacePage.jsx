...
// import { useAuth } from "../../app/providers/AuthProvider";
// import { FK } from "../../capabilities/featureKeys";
// // 🔼 Upgrade flow – same as Messaging workspace
// import { requestUpgrade } from "../../utils/upgradeBus";
...
// export default function CampaignWorkspacePage() {
//   const navigate = useNavigate();
//   // ⬅️ mirror Messaging: also use entLoading
//   const { isLoading, entLoading, can, hasAllAccess } = useAuth();
...
//   // Permission helper – same spirit as Messaging
//   const canAny = codes =>
...
//   // 🔐 Wait for both auth + entitlements like Messaging
//   if (isLoading || entLoading) {
//     return (
//       <div className="p-10 text-center text-lg text-gray-500">
//         Loading campaign features…
...
//   return (
//     <div className="p-6">
//       {/* Local CSS for animated sequential “hand-drawn” border. */}
//       <style>{`
//         @keyframes drawRight { from { transform: scaleX(0) } to { transform: scaleX(1) } }
//         @keyframes drawDown  { from { transform: scaleY(0) } to { transform: scaleY(1) } }
//         @keyframes drawLeft  { from { transform: scaleX(0) } to { transform: scaleX(1) } }
...
//                         {/* Animated border segments (top → right → bottom → left) */}
//                         <span
//                           aria-hidden
//                           className="topline pointer-events-none absolute left-0 -top-[2px] h-[2px] w-full origin-left rounded opacity-0 group-hover:opacity-100"
//                           style={{
...
//   // Safer permission helper: if codes is empty/undefined → treat as "no extra permission needed"
//   const canAny = codes =>
//     hasAllAccess ||
//     (codes || []).length === 0 ||
